...
export const BOSS_ENEMIES: Enemy[] = [
  {
    ...
    hp: 200, maxHp: 200,
    mp: 80, maxMp: 80,
    stats: createBaseStats(18, 8, 15, 15, 12, 6),
    skills: [{
      id: 'goblin_rush', name: '哥布林冲锋', description: '对所有敌人造成120%物理伤害',
      icon: '👑', mpCost: 30, cooldown: 3, currentCooldown: 0,
      damage: 1.2, damageType: 'physical', target: 'all', type: 'physical',
      animation: 'rush',
    }, {
  ...
  },
  {
    ...
    hp: 300, maxHp: 300,
    mp: 200, maxMp: 200,
    stats: { ...createBaseStats(10, 25, 15, 20, 15, 8), iceResist: 50, poisonResist: 100 },
    skills: [{
      id: 'frost_nova', name: '冰霜新星', description: '对所有敌人造成150%魔法伤害，冰冻',
      icon: '❄️', mpCost: 50, cooldown: 4, currentCooldown: 0,
      damage: 1.5, damageType: 'magical', target: 'all', type: 'magical',
      statusEffect: { type: 'freeze', duration: 1, value: 0 },
      animation: 'nova',
    }, {
      id: 'death_decay', name: '死亡凋零', description: '每回合对所有敌人造成30伤害，持续5回合',
      icon: '☠️', mpCost: 80, cooldown: 6, currentCooldown: 0,
      target: 'all', type: 'debuff',
      statusEffect: { type: 'poison', duration: 5, value: 30 },
      animation: 'decay',
    }],
    statusEffects: [],
    aiType: 'boss',
  ...
  },
  {
    ...
    hp: 600, maxHp: 600,
    mp: 300, maxMp: 300,
    stats: { ...createBaseStats(30, 25, 20, 40, 15, 10), fireResist: 80, iceResist: 40 },
  ...
  },
  {
    ...
    hp: 800, maxHp: 800,
    mp: 400, maxMp: 400,
    stats: { ...createBaseStats(35, 35, 30, 35, 20, 15), fireResist: 100 },
    skills: [{
      id: 'hellfire', name: '地狱火', description: '对所有敌人造成200%魔法伤害，灼烧3回合',
      icon: '🔥', mpCost: 100, cooldown: 4, currentCooldown: 0,
      damage: 2.0, damageType: 'magical', target: 'all', type: 'magical',
      statusEffect: { type: 'burn', duration: 3, value: 50 },
      animation: 'hellfire',
    }, {
